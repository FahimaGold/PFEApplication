 ...
 */
public class CollationFragment extends Fragment {

    private TextView textView1;
    private TextView textView2;
    private Random randomGenerator;

    public CollationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myInflatedView =  inflater.inflate( R.layout.fragment_collation, container, false );

        textView1 = (myInflatedView).findViewById( R.id.lunch1 );
        textView2= (myInflatedView).findViewById( R.id.lunch2 );
