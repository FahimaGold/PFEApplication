...
public class HomeDiabetic extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuIdInfos:
                Toast msg = Toast.makeText( HomeDiabetic.this, "Infos", Toast.LENGTH_LONG );
                msg.show();
            ...
            case R.id.menuIdRecettes:
                Toast msg1 = Toast.makeText( HomeDiabetic.this, "Recettes", Toast.LENGTH_LONG );
                msg1.show();
                i = new Intent( getApplicationContext(), ReceipeList.class );
                startActivity( i );
                return true;
            case R.id.menuSeDeconnecter:
                Toast msg2 = Toast.makeText( HomeDiabetic.this, "Se déconnecter", Toast.LENGTH_LONG );
                msg2.show();
            ...
            case 2:
                ...
                Toast msg3 = Toast.makeText( HomeDiabetic.this, "Menu 1", Toast.LENGTH_LONG );
                msg3.show();
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_home_diabetic );
        ...
        if (Login.currentUserEmail != null)
            ...
            Login.currentUserEmail = InscriptionFragment.currentEmailUser ;
        ...
        final boolean updated = databaseHelper.getUpdatedValue();
            ...
            HomeDiabeticFragment homeFragment = new HomeDiabeticFragment();
            android.support.v4.app.FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace( R.id.homeDiabeticSection
                    , homeFragment )
                    .commit();
        ...
        Log.e("getInserted","" + databaseHelper.getInsertedValue());
        Log.e("getUpdated","" + databaseHelper.getUpdatedValue());
        Toast.makeText( this, "getInserted" + databaseHelper.getInsertedValue() , Toast.LENGTH_SHORT ).show();
        Toast.makeText( this, "getUpdated" + databaseHelper.getUpdatedValue() , Toast.LENGTH_SHORT ).show();
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (!obj.getBoolean( "error" )) {
                                    ...
                                    Toast.makeText( HomeDiabetic.this, "Didn't work", Toast.LENGTH_SHORT ).show();
                                }
        ...
        taille = infoMed.getTaille();
            ...
            if (taille != null && poids != null) {
                ...
                if (Float.parseFloat( bmiResult ) >= 25) {
                    ...
                    NotificationCompat.Builder mBuilder = new NotificationCompat.Builder( HomeDiabetic.this, "Test" )
